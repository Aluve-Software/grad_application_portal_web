          ...
          <div class="rounded-3xl border border-gray-100 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 backdrop-blur-2xl">
            <div class="p-8 py-12 sm:p-10">
              <h2 class="mb-2 text-center text-2xl font-bold text-gray-800 dark:text-white">Forgot password?</h2>
               <p class="pb-6 text-center text-sm text-gray-500">Remember your password? <Link class="text-blue-500" to="/login">Login Here</Link></p>    
              <form action="" class="space-y-8">
                <div class="space-y-2">
                  ...
                  <input
                    ...
                    class="focus:outline-none block w-full rounded-md border border-gray-200 dark:border-gray-600 bg-transparent px-4 py-3 text-gray-600 transition duration-300 invalid:ring-2 invalid:ring-red-400 focus:ring-2 focus:ring-blue-500"
                  />
                </div>

                <button type="submit" class="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-blue-500 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
