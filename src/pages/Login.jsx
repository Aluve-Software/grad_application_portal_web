...
import {emailValidate} from '../components/Validate';
import {passwordValidate} from '../components/Validate';
import {loginValidate} from '../components/Validate';
        ...
        <div className="m-auto space-y-8 md:w-8/12 lg:w-6/12 xl:w-6/12">
          <div className="rounded-3xl border border-gray-100 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 backdrop-blur-2xl">
            <div className="p-8 py-12 sm:p-16">
              <h2 className="mb-8 text-center text-2xl font-bold text-gray-800 dark:text-white">Sign in to your account</h2>
              <form onSubmit={formik.handleSubmit} class="space-y-8">
                ...
                <div>
                  <div className="flex items-center text-center justify-between">
                    ...
                    <button className="-mr-2 p-2" type="reset">
                      <Link to="/forgot_password" className="text-sm text-blue-400">Forgot your password?</Link>
                    </button>
                  </div>
                  <input
                    type="password"
                ...
                <button type="submit" className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-blue-500 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
